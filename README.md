...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j1nywaq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j1nywaq.containers.anotherwebservice.com/
...
```
git clone git@github.com:teknowafel/container-j1nywaq.git
cd container-j1nywaq
```
...
```
docker attach container-j1nywaq
```
